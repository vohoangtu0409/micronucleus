            ...
            <div class="<?=$colLeft?>">
                <div class="card card-primary card-outline text-sm">
                    ...
                    <div class="card-body">
                            ...
                            <div class="upload-file mb-2">
                                ...
                                <div class="file-uploaded mb-2">
                                    <a class="btn btn-sm bg-gradient-primary text-white d-inline-block align-middle rounded p-2"
                                        ...
                                        title="Download tập tin hiện tại"><i class="fas fa-download mr-2"></i>Download
                                        tập tin hiện tại</a>
                                </div>
                                <?php } ?>
                        ...
                        <?php if(
                            (isset($config['static'][$type]['heading']) && $config['static'][$type]['heading'] == true) || 
                                ...
                                <div class="tab-content" id="custom-tabs-three-tabContent-lang">
                                    ...
                                    <div class="tab-pane fade show <?=($k=='vi')?'active':''?>" id="tabs-lang-<?=$k?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea
                                                class="form-control for-seo text-sm <?=(isset($config['static'][$type]['desc_cke']) && $config['static'][$type]['desc_cke'] == true)?'form-control-ckeditor':''?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea
                                                class="form-control for-seo text-sm <?=(isset($config['static'][$type]['content_cke']) && $config['static'][$type]['content_cke'] == true)?'form-control-ckeditor':''?>"
